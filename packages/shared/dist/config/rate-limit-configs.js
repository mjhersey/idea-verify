...
exports.RATE_LIMIT_DOCS = exports.SERVICE_CONFIGS = exports.MOCK_QUOTA_CONFIG = exports.MOCK_RATE_LIMITS = exports.AWS_QUOTA_CONFIG = exports.AWS_RATE_LIMITS = exports.ANTHROPIC_QUOTA_CONFIG = exports.ANTHROPIC_RATE_LIMITS = exports.OPENAI_QUOTA_CONFIG = exports.OPENAI_RATE_LIMITS = void 0;
exports.getServiceConfig = getServiceConfig;
/**
 * OpenAI API Rate Limits (as of 2024)
 * Based on tier and model usage
 */
exports.OPENAI_RATE_LIMITS = {
...
function getServiceConfig(serviceName) {
    const baseConfig = exports.SERVICE_CONFIGS[serviceName];
    if (!baseConfig) {
