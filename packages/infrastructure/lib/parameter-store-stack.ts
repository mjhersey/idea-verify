...
export class ParameterStoreStack extends cdk.Stack {
  ...
  private createFeatureFlags(environment: string): void {
    ...
    this.parameters.enableMetricsCollection = new ssm.StringParameter(
      this,
  ...
  private createApplicationConfig(environment: string): void {
    ...
    this.parameters.maxConcurrentEvaluations = new ssm.StringParameter(
      this,
    ...
    this.parameters.evaluationRetryAttempts = new ssm.StringParameter(
      this,
      'EvaluationRetryAttempts',
      {
