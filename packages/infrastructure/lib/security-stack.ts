...
export class SecurityStack extends cdk.Stack {
  ...
  private configureNetworkACLs(infrastructureStack: AiValidationPlatformStack, environment: string): void {
    const vpc = infrastructureStack.vpc;
  ...
  private createComplianceResources(environment: string): void {
    ...
    securityScanRole.addToPolicy(new iam.PolicyStatement({
