...
describe('WebSocket Store', () => {
  ...
  describe('Connection Management', () => {
    ...
    it('should handle connection failure', async () => {
      ...
      // Make connect fail
      vi.mocked(mockWebSocket.useWebSocket().connect).mockRejectedValue(new Error('Connection failed'));
  ...
  describe('Event Handlers', () => {
    ...
    it('should handle agent progress events', () => {
      ...
      expect(store.currentEvaluation?.agentProgresses['market-research'].progressPercentage).toBe(75);
    });
    ...
    it('should handle evaluation status events', () => {
      ...
      expect(store.currentEvaluation?.activeAgents).toEqual(['market-research', 'technical-feasibility']);
