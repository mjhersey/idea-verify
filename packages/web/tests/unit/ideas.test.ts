...
describe('IdeasService', () => {
  ...
  describe('submitIdea', () => {
    const validIdea = {
      title: 'Test Idea',
      description:
        'This is a valid business idea description that meets the minimum character requirements for submission.',
    }
  ...
  describe('validateIdeaSubmission', () => {
    it('should validate valid idea', () => {
      const validIdea = {
        title: 'Valid Title',
        description:
          'This is a valid description that meets all the requirements including the minimum character count.',
      }
    ...
    it('should reject short title', () => {
      const invalidIdea = {
        title: 'Hi',
        description:
          'This is a valid description that meets the minimum character requirements for submission to the platform.',
      }
    ...
    it('should allow missing title', () => {
      const validIdea = {
        description:
          'This is a valid description without a title that meets the minimum character requirements.',
      }
...
describe('useIdeas composable', () => {
  ...
  it('should validate description correctly', () => {
    ...
    expect(
      validateDescription(
        'This is a valid description that meets the minimum character requirements.'
      )
    ).toBe(null)
  })
