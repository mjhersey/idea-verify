...
const containerClasses = computed(() => {
  ...
  if (props.overlay) {
    base.push('absolute inset-0 bg-white bg-opacity-75', 'flex items-center justify-center z-50')
  }
...
const spinnerClasses = computed(() => {
  ...
  return [...base, sizeClasses[props.size], colorClasses[props.color]].join(' ')
})
...
const textClasses = computed(() => {
  ...
  return [...base, colorClasses[props.color]].join(' ')
})
</script>
