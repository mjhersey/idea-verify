    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div v-if="error" class="bg-red-50 border border-red-200 rounded-md p-4">
        <div class="flex">
          ...
          <div class="ml-auto pl-3">
            <button class="inline-flex text-red-400 hover:text-red-600" @click="clearError">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        ...
        <div>
          ...
          >
            <span v-if="isLoggingIn" class="absolute left-0 inset-y-0 flex items-center pl-3">
              <svg
...
const isFormValid = computed(
  () => !emailError.value && !passwordError.value && form.value.email && form.value.password
)
