...
export class ErrorHandler {
  ...
  invalidAgentType(agentType: string): APIError {
    return this.createError(
      ...
      { validTypes: ['market-research', 'competitive-analysis', 'customer-research', 'technical-feasibility', 'financial-analysis'] }
    );
  }
  ...
  static createMiddleware(): (error: Error, req: Request, res: Response, next: NextFunction) => void {
