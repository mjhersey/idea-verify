...
export interface ValidationInsight {
  type: 'problem-validation' | 'market-demand' | 'segment-opportunity' | 'pricing-insight' | 'persona-recommendation';
  title: string;
  description: string;
...
export interface DataSource {
  name: string;
  url?: string;
  type: 'forum' | 'social-media' | 'survey' | 'review-site' | 'demographic-data' | 'industry-report' | 'interview';
