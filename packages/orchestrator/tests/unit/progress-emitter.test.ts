...
describe('ProgressEmitter', () => {
  ...
  describe('Insight Discovery Events', () => {
    it('should emit insight discovered events correctly', () => {
      ...
      progressEmitter.emitInsightDiscovered(evaluationId, agentType, insight, confidence, metadata)
  ...
  describe('Error Events', () => {
    it('should emit error events correctly', () => {
      ...
      progressEmitter.emitError(evaluationId, error, severity, agentType, recoveryActions)
  ...
  describe('Evaluation Completed Events', () => {
    it('should emit evaluation completed events correctly', () => {
      ...
      progressEmitter.emitEvaluationCompleted(evaluationId, finalResults, totalTime, agentSummaries)
