...
describe('MessageBus', () => {
  ...
  describe('Message Publishing and Subscription', () => {
    it('should publish and receive messages', async () => {
      ...
      const message = messageBus.createMessage<AgentStartMessage>(MessageType.AGENT_START, {
  ...
  describe('Request/Response Pattern', () => {
    it('should handle request/response with replyTo', async () => {
      ...
      const requestMessage = messageBus.createMessage<AgentStartMessage>(MessageType.AGENT_START, {
        evaluationId: 'test-eval',
        agentType: 'market-research',
        businessIdea: {
          id: 'test-idea',
