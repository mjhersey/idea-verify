...
This directory contains the complete database infrastructure for the AI-Powered
Business Idea Validation Platform, implementing Story 1.2 requirements with
Prisma ORM, PostgreSQL, and comprehensive connection management.
...
console.log(
  `Connections: ${info.connectionStats?.active}/${info.connectionStats?.maxConnections}`
)
