...
class PerformanceTester {
  ...
  async runLoadTest(
    ...
    duration: number = this.config.testDuration
  ...
  getPerformanceSummary(): any {
    return {
      ...
      averageResponseTime:
        this.testResults.reduce((sum, r) => sum + r.metrics.averageResponseTime, 0) /
        this.testResults.length,
      overallErrorRate:
        this.testResults.reduce((sum, r) => sum + r.metrics.errorRate, 0) / this.testResults.length,
...
describe('Performance Tests', () => {
  ...
  describe('Health Endpoints', () => {
    test(
      'should handle load on health endpoint',
      async () => {
    ...
    test(
      'should handle load on API health endpoint',
      async () => {
  ...
  describe('Authentication', () => {
    test(
      'should handle authentication load',
      async () => {
  ...
  describe('API Endpoints', () => {
    test(
      'should handle load on protected endpoints',
      async () => {
    ...
    test(
      'should handle load on business ideas endpoints',
      async () => {
  ...
  describe('Database Performance', () => {
    test(
      'should handle database operations under load',
      async () => {
  ...
  describe('Stress Testing', () => {
    test(
      'should identify system stress limits',
      async () => {
  ...
  describe('Resource Management', () => {
    test(
      ...
      config.timeout * 2
    ) // Extended timeout for memory leak testing

    test(
      'should enforce rate limiting appropriately',
      async () => {
